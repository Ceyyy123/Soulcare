...
const DailyQuote = () => {
  ...
  useEffect(() => {
    ...
    const randomQuote = quotes[today % quotes.length];
    const shuffledTips = dailyTips.sort(() => 0.5 - Math.random()).slice(0, 3);
        ...
        <div className={styles.content}>
          ...
          <div className={styles.additionalResources}>
            ...
            <Link href="/usefulresources">
              <button className={styles.resourceButton}>Zu den Ressourcen</button>
            </Link>
          </div>
        </div>
      </div>
