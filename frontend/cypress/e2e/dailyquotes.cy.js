describe('Zitate und Tipps anzeigen', () => {
  it('should display the daily quote and tips when clicked', () => {
    // Zuerst anmelden
    ...
    // Klicke auf den Bereich für Zitate und Tipps
    cy.visit('/dailyquote') // Klicke auf „Zitate und Tipps“
